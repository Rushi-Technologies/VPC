...
resource "aws_subnet" "public" {
  ...
  availability_zone = length(var.public_subnets_azs) > 0 ? element(var.public_subnets_azs,count.index)  : null
...
resource "aws_subnet" "private" {
  ...
  availability_zone = length(var.private_subnets_azs) > 0 ? element(var.private_subnets_azs,count.index)  : null
